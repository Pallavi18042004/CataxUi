  ...
  return (
    <>
      <div className="container mt-24 mx-auto  max-w-5xl px-4 lg:hidden">
        <div className="heading text-[24px] text-nowrap md:text-[48px] text-center font-medium mb-12">
        ...
        <div className="flex justify-center items-center flex-wrap gap-2 ">
          {[
            ...
            <div
              key={index}
              className="flex border-2 hover:shadow-md p-2 h-14 w-60 rounded-md items-center "
            >
