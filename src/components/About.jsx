            ...
            >
                <div className='grid grid-cols-1 gap-x-16 sm:grid-cols-2 lg:grid-cols-4 m-auto items-center  '>
                    <div className='flex gap-x-4 '>
                        <p className='text-[30px] font-bold sm:text-' >50M</p>
                    ...
                    <div className='flex gap-x-4 '>
                        <p className='text-[30px] font-bold sm:text-'>142k+</p>
                        <div className='flex flex-col gap-y-6'>
                    ...
                    <div className='flex gap-x-4 '>
                        <p className='text-[30px] font-bold sm:text-'>450+</p>
                        <div className='flex flex-col gap-y-6'>
                    ...
                    <div className='flex   gap-x-4 '>
                        <p className='text-[30px] font-bold sm:text-'>$1M</p>
                        <div className='flex flex-col gap-y-6'>
