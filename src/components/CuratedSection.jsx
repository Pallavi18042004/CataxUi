        ...
        >
          <g id="solar:user-broken">
            <g id="Group">
              ...
              <g id="Vector_2">
                <path
                  d="M39.996 36C39.9987 35.672 40 35.3387 40 35C40 30.03 32.836 26 24 26C15.164 26 8 30.03 8 35C8 39.97 8 44 24 44C28.462 44 31.68 43.686 34 43.126"
                  fill="#FFE0E0"
                />
                <path
                  d="M39.996 36C39.9987 35.672 40 35.3387 40 35C40 30.03 32.836 26 24 26C15.164 26 8 30.03 8 35C8 39.97 8 44 24 44C28.462 44 31.68 43.686 34 43.126"
